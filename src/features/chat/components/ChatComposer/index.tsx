...
export function ChatComposer(props: ChatComposerProps) {
  ...
  return (
    <form class={styles.composer} onSubmit={submitMessage}>
      ...
      <label class={styles.thinkingToggle}>
        <input
          ...
          disabled={props.isSubmitting}
          onChange={(event) => props.onThinkingEnabledChange(event.currentTarget.checked)}
        />
        <span>{props.isThinkingEnabled ? t('thinkingModeOn') : t('thinkingModeOff')}</span>
      </label>
      <button
